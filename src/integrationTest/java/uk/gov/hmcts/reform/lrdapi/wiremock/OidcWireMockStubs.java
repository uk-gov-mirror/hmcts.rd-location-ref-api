...
import static uk.gov.hmcts.reform.lrdapi.util.KeyGenUtil.getDynamicJwksResponse;
...
public final class OidcWireMockStubs {
    ...
    public static void registerDefaults(WireMockServer server) throws JOSEException, JsonProcessingException {
    ...
    private static void registerJwks(WireMockServer server) throws JOSEException, JsonProcessingException {
        server.stubFor(
    ...
    private static void registerJwksRoot(WireMockServer server) throws JOSEException, JsonProcessingException {
        server.stubFor(
                get(urlEqualTo("/o"))
                        .willReturn(
                                aResponse()
