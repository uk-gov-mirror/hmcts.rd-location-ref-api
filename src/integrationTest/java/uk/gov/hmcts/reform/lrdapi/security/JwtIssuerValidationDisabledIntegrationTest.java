...
import static uk.gov.hmcts.reform.lrdapi.security.BaseSecurityIntegrationTest.VALID_ISSUER_1;
import static uk.gov.hmcts.reform.lrdapi.security.BaseSecurityIntegrationTest.VALID_ISSUER_2;
...
public class JwtIssuerValidationDisabledIntegrationTest extends BaseSecurityIntegrationTest {
    ...
    private void mockRegions() {
        when(regionService.retrieveRegionDetails(any(), any())).thenReturn(Collections.emptyList());
    }
}
